...
*/
// RNL 10/15/2025: Modified original 5 questions and added five more questions related to 7th Grade Comp Sci lesson development
...
choice6[1]="It moves around the room."
choice6[2]="It asks a person for the answer."
choice6[3]="It follows the instructions in the algorithm exactly."
choice6[4]="It guesses what to do next."

question[7]="If you are building a LEGO set using the instruction booklet, the booklet is like..."
choice7[1]="The LEGO bricks."
choice7[2]="The finished LEGO model."
choice7[3]="The box it came in."
choice7[4]="An algorithm."

question[8]="Which of the following problems could be solved with an algorithm?"
choice8[1]="Deciding your favorite color."
choice8[2]="Sorting a list of names alphabetically."
choice8[3]="Feeling happy or sad."
choice8[4]="Guessing a random number."

question[9]="A computer program is essentially..."
choice9[1]="The computer's power cord."
choice9[2]="The physical screen and keyboard."
choice9[3]="An algorithm written in a language the computer understands."
choice9[4]="A person who tells the computer what to do."

question[10]="What is a \"bug\" in a computer science algorithm?"
choice10[1]="An insect inside the computer."
choice10[2]="An error in the instructions that causes a wrong result."
choice10[3]="A feature that makes the program better."
choice10[4]="The person who wrote the algorithm."
